...
cwd = os.getcwd()
source_folder = r"//aocaazurefiles.file.core.windows.net/assetmgt/PM - Structured Credit/Relative Value/Historical Spreads - WF"
base_name = 'Non-Agency RMBS - Weekly Spreads Report'
